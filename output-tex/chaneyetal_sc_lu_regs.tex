...
% Date and time: Tue, Feb 17, 2026 - 14:31:56
...
Natl Mortgage Rate  & (0.004) &  &  \\ 
  & & & \\ 
 Baum-Snow \& Han $\times$ &  & 0.026 &  \\ 
Natl Mortgage Rate  &  & (0.017) &  \\ 
  & & & \\ 
 LU-ML &  &  & 0.834$^{***}$ \\ 
  &  &  & (0.040) \\ 
  & & & \\ 
\hline \\[-1.8ex] 
First Stage $F$-Stat & 43.13 & 2.38 & 430.44 \\
First Stage Partial $R^{2}$ & 0.23 & 0.01 & 0.33 \\
\\[-2.0ex] \hline \\[-2.0ex]
Number of MSAs & 97 & 322 & 354 \\
Observations & 1,358 & 4,499 & 4,936 \\ 
\\[-2.0ex] \hline \\[-2.0ex]
